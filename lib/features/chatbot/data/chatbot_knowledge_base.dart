...
class ChatbotKnowledgeBase {
  ...
  static const List<ChatbotFaqEntry> faqs = [
    ...
    ChatbotFaqEntry(
      ...
      answer: 'This app helps MUST students, lecturers, and admins manage academic networking and collaboration. You can showcase projects, create opportunities, discover people by skills, send messages, form groups, and receive AI-assisted recommendations. Lecturers can review and rank applicants, while admins can moderate content and manage platform analytics. Guests can browse public content, but account-based actions like posting and messaging require sign-in.',
      keywords: ['what does this app do', 'what does this application do', 'what can this app do', 'what is this app for', 'purpose of this app', 'application overview'],
      actions: [
        ChatbotAction(label: 'Browse Home Feed', route: RouteNames.home),
      ],
      followUps: [
    ...
    ChatbotFaqEntry(
      ...
      answer: 'Welcome to MUST StarTrack! To get started: (1) Sign in with your MUST email account or register if you are new. (2) Complete your profile by adding a bio, skills, and a profile picture. (3) Explore the Home feed to see posts from your peers. (4) Visit Discover to find students and projects matching your interests. (5) Create your first project post to showcase your work. You can browse as a guest without logging in, but posting, messaging, and applying requires an account.',
      keywords: ['started', 'begin', 'signup', 'register', 'newcomer', 'first time', 'welcome'],
      actions: [
    ...
    ChatbotFaqEntry(
      ...
      answer: 'The Home feed is your personalized dashboard showing posts from peers, collaborators, and your network. It displays project showcases, opportunity postings, and activity from people you follow. You can like posts, comment, share, and apply to opportunities. The feed is sorted by relevance using AI recommendations based on your skills and interests. Pull down to refresh and scroll to load more posts.',
    ...
    ChatbotFaqEntry(
      ...
      answer: 'Post visibility controls who can see your post. Public posts are visible to everyone on the platform and in the Home feed. Private posts are visible only to you and people you choose to share with. When creating a post, you can set visibility in the post settings. This is useful if you want to draft a post before sharing or if you want to keep certain work private until you are ready.',
      keywords: ['visibility', 'public', 'private', 'share', 'who can see', 'permissions'],
    ),
    ChatbotFaqEntry(
      id: 'faq_edit_delete_post',
      group: 'Posts & Projects',
      question: 'Can I edit or delete my post after publishing?',
      answer: 'Yes, you can edit or delete your own posts. Go to My Projects from your profile to see all your posts. Tap the More menu on any post to edit the title, description, or media, or to delete the post entirely. Changes are synced to the platform immediately. Once deleted, the post cannot be recovered.',
      keywords: ['edit', 'delete', 'modify', 'remove', 'post', 'my projects'],
      actions: [
        ChatbotAction(label: 'View My Projects', route: RouteNames.projects),
      ],
    ),
    ChatbotFaqEntry(
      ...
      actions: [
        ChatbotAction(label: 'Check Notifications', route: RouteNames.notifications),
      ],
    ),
    ChatbotFaqEntry(
      ...
      answer: 'To engage with a post: (1) Tap the post to open details. (2) Use the action buttons: tap the heart icon to like, comment icon to add a comment, or share icon to share with others. You can also add emoji reactions to comments. Likes and comments help boost the visibility of posts in the feed and show support to creators.',
      keywords: ['like', 'comment', 'share', 'reaction', 'engage', 'interaction'],
    ),
    ChatbotFaqEntry(
      id: 'faq_media_upload',
      group: 'Posts & Projects',
      question: 'What media can I upload to a post?',
      answer: 'You can upload images (PNG, JPG) and videos (MP4, MOV) to your posts. Images are displayed as galleries and videos are embedded inline. Media is stored securely on Cloudinary. Keep files under reasonable sizes for smooth uploading (images under 10MB, videos under 100MB recommended). You can add multiple images and videos to a single post.',
      keywords: ['media', 'upload', 'image', 'video', 'photo', 'file', 'attachment'],
    ),
    ...
    ChatbotFaqEntry(
      ...
      answer: 'To edit your profile: (1) Go to your My Profile screen. (2) Tap the Edit Profile button. (3) Update your bio, profile picture, skills, links, or other information. (4) You cannot change your faculty or program after registration to maintain academic record integrity. (5) Tap Save to save changes. Changes are visible immediately to other users.',
      keywords: ['edit', 'profile', 'bio', 'picture', 'skills', 'links', 'update'],
      actions: [
        ChatbotAction(label: 'Edit Profile', route: RouteNames.editProfile),
      ],
    ),
    ...
    ChatbotFaqEntry(
      ...
      answer: 'Achievements (courses, certifications, awards) help showcase your qualifications. Go to your profile, tap Achievements, and add certifications you have completed or awards you have received. This builds credibility and helps peers and lecturers understand your expertise.',
      keywords: ['achievement', 'certificate', 'award', 'course', 'credential', 'qualification'],
      actions: [
    ...
    ChatbotFaqEntry(
      ...
      keywords: ['collaborators', 'find', 'team', 'peers', 'discover', 'matching', 'skills'],
      actions: [
    ...
    ChatbotFaqEntry(
      ...
      answer: 'To send a collab request: (1) Visit someone\'s profile. (2) Tap Send Collab Request. (3) Select the project you want to collaborate on or describe the collaboration. (4) Send. They will see your request in notifications. To respond to a request you received, go to your Peers screen and check pending collaboration requests. You can accept to become collaborators or decline to reject.',
      keywords: ['collaboration', 'collab request', 'request', 'team', 'accept', 'decline'],
      actions: [
        ChatbotAction(label: 'View Peers', route: RouteNames.peers),
      ],
    ),
    ...
    ChatbotFaqEntry(
      ...
      answer: 'Notifications alert you to important events like: someone commenting on your post, a message from a peer, a collaboration request, an application to your opportunity post, a like on your work, or admin announcements. You can see all notifications in the Notification Center. Each notification links you directly to the related content.',
      keywords: ['notification', 'alert', 'center', 'notification center', 'feedback'],
      actions: [
        ChatbotAction(label: 'View Notifications', route: RouteNames.notifications),
      ],
    ),
    ChatbotFaqEntry(
      ...
      answer: 'Go to Notification Settings from the drawer menu to customize how you receive alerts. You can enable/disable notifications for: comments, collaboration requests, messages, likes, application updates, recommendations, and more. You can also choose between push notifications, in-app alerts, or email summaries.',
      keywords: ['notification settings', 'manage', 'alerts', 'preferences', 'customize'],
      actions: [
        ChatbotAction(label: 'Notification Settings', route: RouteNames.notificationSettings),
      ],
    ),
    ChatbotFaqEntry(
    ...
    ChatbotFaqEntry(
      ...
      answer: 'MUST StarTrack uses a hybrid, local-first recommender. First, the app scores posts locally using your skills, faculty, program, recent searches, recent activity, recency of posts, engagement, and opportunity fit. Then, if Gemini is configured, it can rerank the top results rather than replacing the whole system. This is used in the Home feed, Discover, collaborator suggestions, and lecturer applicant ranking. Even when Gemini is unavailable, the local ranking still works, so recommendations do not stop completely.',
      keywords: [
        'recommendations',
        'ai',
        'personalized',
    ...
    ChatbotFaqEntry(
      id: 'faq_gemini_unavailable',
      group: 'Discover & Recommendations',
      question: 'What happens when Gemini is unavailable?',
      answer: 'The app falls back to local-first behavior. Recommendations still work using local ranking, and the assistant still answers using FAQ and embedded project knowledge. Gemini improves explanation quality and can rerank results, but the app is intentionally designed so that its important workflows do not stop when Gemini is unavailable or not configured.',
      keywords: [
        'what happens when gemini is unavailable',
        'if gemini is off',
    ...
    ChatbotFaqEntry(
      ...
      answer: 'AI nudges are personalized suggestions from the platform to encourage engagement. For example, you might receive nudges like "Complete your profile to improve recommendations" or "You have 3 new skill-matching posts available." Nudges appear as notifications and on your Discover screen. They are designed to help you discover relevant content and build connections.',
      keywords: ['nudges', 'ai nudges', 'suggestions', 'recommendations', 'hints'],
    ),
    ChatbotFaqEntry(
      id: 'faq_gemini_usage',
      group: 'Discover & Recommendations',
      question: 'Is Gemini used in this app?',
      answer: 'Yes. Gemini is used in two main places when configured: first, as an optional reranking layer for recommendations; second, as the assistant fallback when local FAQ and project knowledge are not enough. The app still keeps important logic local-first, so feed ranking and assistant answers do not depend entirely on Gemini to work.',
      keywords: ['is gemini used in this app', 'gemini', 'ai model', 'does the app use gemini', 'gemini integration', 'is ai used in this app'],
      followUps: [
        'How do the recommender algorithms work?',
        'What happens when Gemini is unavailable?',
      ],
    ...
    ChatbotFaqEntry(
      ...
      answer: 'The Lecturer Dashboard (for lecturers) provides analytics and management tools: (1) View all opportunity postings you have created. (2) Track applications and applicants. (3) See rankings of applicants based on skill match and activity. (4) Manage shortlisted candidates. (5) Filter and search applicants. (6) View detailed profiles of candidates. (7) Export reports. Use this to manage your recruitment and collaboration workflows.',
      keywords: ['lecturer', 'dashboard', 'lecturer dashboard', 'manage', 'opportunities', 'applicants'],
      actions: [
        ChatbotAction(label: 'Lecturer Dashboard', route: RouteNames.lecturerDashboard),
      ],
    ),
    ChatbotFaqEntry(
      ...
      answer: 'The Admin Dashboard (for admins and super admins) provides platform management and analytics: (1) User management: view, edit, or suspend users. (2) Activity analytics: see platform engagement trends. (3) Moderation: review reported posts and enforce community guidelines. (4) Faculty management: manage academic units. (5) Course management: organize course data. (6) Groups management: oversee group creation and moderation. (7) Chatbot analytics: track assistant accuracy and training. Use this to maintain a healthy platform ecosystem.',
      keywords: ['admin', 'dashboard', 'admin dashboard', 'management', 'moderation', 'analytics'],
      actions: [
        ChatbotAction(label: 'Admin Dashboard', route: RouteNames.adminDashboard),
      ],
    ),
    ChatbotFaqEntry(
      id: 'faq_moderation',
      ...
      answer: 'Users can report posts that violate community guidelines. Reports go to the admin moderation queue. Admins review: the reported post, the reason for report, user history, and context. Actions: approve (keep post), remove (delete post), or warn user. Repeat violations may result in account suspension. Reports are anonymous and cases are documented for accountability.',
      keywords: ['moderation', 'report', 'admin', 'violation', 'policy', 'community guidelines'],
    ),
    ...
    ChatbotFaqEntry(
      ...
      answer: 'MUST StarTrack supports multiple roles: (1) Student: can post projects, apply to opportunities, find collaborators. (2) Lecturer: can post opportunities, manage applicants, access lecturer analytics. (3) Admin: can moderate content, manage users and faculty. (4) Super Admin: full platform management including configuration and system settings.',
      keywords: ['account', 'types', 'roles', 'student', 'lecturer', 'admin', 'super admin'],
    ),
    ChatbotFaqEntry(
      id: 'faq_signin',
      group: 'Account & Security',
      question: 'How do I sign in?',
      answer: 'To sign in: (1) On the Login screen, enter your MUST email (must@mustmak.ac.ug or similar). (2) Enter your password. (3) Tap Sign In. If you don\'t have an account, tap Register and complete the registration steps. If you forgot your password, tap Forgot Password and follow the email instructions.',
    ...
    ChatbotFaqEntry(
      ...
      answer: 'To register: (1) Tap Register from the Login screen. (2) Enter your MUST email address. (3) Create a strong password. (4) Select your role (Student or Lecturer). (5) Confirm your faculty, program, and other details (these cannot be changed later). (6) Add your profile information: bio, skills, profile picture. (7) Tap Create Account. You will be signed in automatically and taken to the onboarding.',
      keywords: ['register', 'signup', 'new account', 'registration', 'join', 'sign up'],
      actions: [
        ChatbotAction(label: 'Sign In', route: RouteNames.login),
      ],
    ),
  ...
  static const List<ChatbotKnowledgeDoc> projectDocs = [
    ...
    ChatbotKnowledgeDoc(
      ...
      summary: 'Recommendation logic is used in the Home feed, Discover, collaborator recommendation, AI-facing screens, and lecturer applicant ranking.',
      content: 'Recommendation logic supports multiple surfaces in the app. Personalized feed ranking orders posts in the Home feed, Discover reranks search results, collaborator recommendation suggests relevant peers, AI-facing screens expose recommendations and nudges, and lecturer ranking helps sort applicants based on fit and activity. This makes recommendations part of both student-facing and lecturer-facing workflows.',
      keywords: [
    ...
    ChatbotKnowledgeDoc(
      ...
      summary: 'Groups let peers collaborate as a team, invite accepted collaborators, and publish group-attributed posts that appear in group flows and can be filtered in feeds.',
      content: 'Groups are built around accepted collaborator relationships. A group has members with owner, admin, or member roles. Group posts reuse the normal post pipeline but include a group identifier so they can appear in group feeds and lecturer/admin views. Group creation starts from the peers flow, then users invite eligible collaborators, manage members, and publish work inside the group.',
      keywords: [
        'groups',
        'group posts',
        'group collaboration',
    ...
    ChatbotKnowledgeDoc(
      ...
      summary: 'The app uses Flutter with BLoC, get_it, GoRouter, Firebase, and SQLite in a local-first architecture.',
      content: 'MUST StarTrack is structured around Flutter UI, feature modules, BLoC/Cubit state management, GoRouter navigation, get_it dependency injection, SQLite persistence, and Firebase-backed remote services. It is designed to remain useful offline or under weak connectivity, with local storage and sync-aware workflows supporting the main experience. Gemini is integrated as a supporting AI layer rather than the foundation of all app behavior.',
      keywords: [
        'architecture',
    ...
    ChatbotKnowledgeDoc(
      ...
      summary: 'MUST StarTrack is a skill-centric academic networking platform for project showcasing, discovery, collaboration, recommendations, messaging, and role-based workflows.',
      content: 'The app supports students, lecturers, admins, and super admins. Core areas include the Home feed, Discover, Peers, Messaging, Notifications, Profiles, AI recommendations, lecturer ranking tools, and admin analytics. Guests can browse public content, while signed-in users unlock posting, messaging, applications, and collaboration features.',
      keywords: [
        'platform',
        'overview',
        'features',
    ...
    ChatbotKnowledgeDoc(
      id: 'doc_gemini_usage',
      title: 'Gemini Usage',
      summary: 'Gemini is used in the app as an optional reranking layer for recommendations and as fallback reasoning for the in-app assistant when local knowledge is not enough.',
      content: 'The recommendation system is local-first, but when Gemini is configured it can rerank top results. The chatbot assistant also uses Gemini as a fallback after searching the local FAQ and embedded project knowledge. This means Gemini supports the app, but critical product behavior does not fully depend on it. If Gemini is unavailable, the local recommendation logic and FAQ-based answers still continue to work.',
      keywords: [
        'gemini',
        'is gemini used in this app',
        'gemini integration',
    ...
    ChatbotKnowledgeDoc(
      ...
      summary: 'The app is designed to remain useful even when connectivity is weak by favoring local persistence and local-first decision paths.',
      content: 'MUST StarTrack uses a local-first approach so that important workflows continue even when remote AI or network access is limited. SQLite-backed persistence, sync-aware design, and local FAQ or ranking logic help preserve core functionality. Gemini improves the system when configured, but assistant answers and recommendations still retain local fallbacks.',
      keywords: [
        'offline first',
        'offline',
        'weak network',
